                    ...
                    >
                        ...
                        <div className="flex items-center gap-2 px-2 py-1 border-b">
                            ...
                            <Button
                                ...
                                size="icon"
                                onClick={() =>
                                    (document.getElementById(`opts-${pin.id}`) as HTMLButtonElement)?.click()
                                }
                                title="Options"
                            >
                        ...
                        <div className="space-y-1.5 md:col-span-3">
                            ...
                            <Input
                                ...
                                onChange={(e) => {
                                    ...
                                    const nextRange = [
                                        Number.isFinite(min as number) ? (min as number) : undefined,
                                        Number.isFinite(max as number) ? (max as number) : undefined,
