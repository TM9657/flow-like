            ...
            >
                ...
                <g strokeWidth="1.5">
                    <motion.g
                        ...
                        variants={{
                            ...
                            assembled: { x: 0, y: 0, scale: 1, opacity: 1, transition: { ...dockTransition, delay: 0.05 } }
                        }}
                    >
                    ...
                    <motion.g
                        ...
                        variants={{
                            initial: { x: 10, y: -10, scale: 0.5, opacity: 0, transition: retreatTransition },
                            assembled: { x: 0, y: 0, scale: 1, opacity: 1, transition: { ...dockTransition, delay: 0.1 } }
                        }}
                    >
                    ...
                    <motion.g
                        ...
                        variants={{
                            initial: { x: 10, y: 10, scale: 0.5, opacity: 0, transition: retreatTransition },
                            assembled: { x: 0, y: 0, scale: 1, opacity: 1, transition: { ...dockTransition, delay: 0.15 } }
                        }}
                    >
                    ...
                    <motion.g
                        ...
                        variants={{
                            initial: { x: -10, y: 10, scale: 0.5, opacity: 0, transition: retreatTransition },
                            assembled: { x: 0, y: 0, scale: 1, opacity: 1, transition: { ...dockTransition, delay: 0.2 } }
                        }}
                    >
                ...
                <motion.g
                    className={cn(
                        ...
                        isAssembled ? "stroke-emerald-500 dark:stroke-emerald-400" : "stroke-currentColor"
                    )}
                    variants={{
                        initial: { rotate: 0, scale: 1, transition: retreatTransition },
                        assembled: { rotate: 180, scale: 1.1, transition: { type: "spring", stiffness: 300, damping: 15 } }
                    }}
