...
function PropertyField({ name, value, onChange, isAssetProperty, componentType }: PropertyFieldProps) {
...
function BoundValueEditor({ name, value, onChange, isAssetProperty, appId, assetAccept = "all" }: BoundValueEditorProps) {
