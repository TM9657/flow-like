			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="py-8 border-b border-border/40">
					<div className="flex flex-col sm:flex-row items-center justify-between gap-4">
						<div>
							...
							<p className="text-muted-foreground text-sm">{t("footer.cta.description")}</p>
						</div>
						<a
							href="/download"
				...
				<div className="py-10 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
					...
					<FooterSection title={t("footer.section.product")}>
						<FooterLink href="/download">{t("footer.link.download")}</FooterLink>
						<FooterLink href="/compare">{t("footer.link.compare")}</FooterLink>
						<FooterLink href="/modern-bi">{t("footer.link.modernBi")}</FooterLink>
						<FooterLink href="/24-hour-solution">{t("footer.link.24h")}</FooterLink>
					</FooterSection>

					{/* Resources */}
					<FooterSection title={t("footer.section.resources")}>
						<FooterLink href="https://docs.flow-like.com/start/getting-started" external>{t("footer.link.gettingStarted")}</FooterLink>
						<FooterLink href="https://docs.flow-like.com/start/what-is-flow-like" external>{t("footer.link.whatIs")}</FooterLink>
						<FooterLink href="https://docs.flow-like.com/self-hosting" external>{t("footer.link.selfHosting")}</FooterLink>
						<FooterLink href="https://docs.flow-like.com/nodes" external>{t("footer.link.nodes")}</FooterLink>
					</FooterSection>

					{/* Blog */}
					<FooterSection title={t("footer.section.blog")}>
						<FooterLink href="/blog/2026-01-01-alpha-0-0-7">{t("footer.link.latestRelease")}</FooterLink>
						<FooterLink href="/blog/2025-08-09-agents-vs-automation">{t("footer.link.agentsVsAutomation")}</FooterLink>
						<FooterLink href="/blog/2025-09-13-n8n-flow-like">{t("footer.link.n8nComparison")}</FooterLink>
						<FooterLink href="/blog">{t("footer.link.allPosts")}</FooterLink>
					</FooterSection>

					{/* Company */}
					<FooterSection title={t("footer.section.company")}>
						<FooterLink href="https://github.com/TM9657/flow-like" external>{t("footer.link.github")}</FooterLink>
						<FooterLink href="https://github.com/TM9657/flow-like/discussions" external>{t("footer.link.community")}</FooterLink>
						<FooterLink href="mailto:contact@flow-like.com">{t("footer.link.contact")}</FooterLink>
					</FooterSection>
					...
					<FooterSection title={t("footer.section.legal")}>
						...
						<FooterLink href="https://great-co.de/legal-notice" external>{t("footer.legal")}</FooterLink>
						<FooterLink href="/thirdparty">{t("footer.link.thirdParty")}</FooterLink>
					</FooterSection>
				</div>
