...
export function BlogHeader() {
	return (
		<header className="w-full flex flex-row items-center sticky top-0 left-0 right-0 min-h-16 h-16 z-20 backdrop-blur-sm shadow-md bg-background/40 justify-between">
