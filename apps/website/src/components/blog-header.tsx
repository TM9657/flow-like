        ...
        >
          ...
          >
            <div className="flex items-center justify-between p-4">
              <a href="/" className="flex items-center gap-2" onClick={handleNavLinkClick}>
    ...
    <>
      <header className="w-full flex flex-row items-center sticky top-0 left-0 right-0 min-h-16 h-16 z-20 backdrop-blur-sm shadow-md bg-background/40 justify-between px-2">
        ...
        <div className="hidden sm:flex flex-row items-center gap-2">
          ...
          <a href="https://github.com/TM9657/flow-like" target="_blank" rel="noreferrer">
          ...
          <a href="https://discord.com/invite/KTWMrS2/" target="_blank" rel="noreferrer">
            <Button variant={"outline"} size={"icon"}>
              <BsDiscord className="w-5 h-5" />
            </Button>
          </a>
