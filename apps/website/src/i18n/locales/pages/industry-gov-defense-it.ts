export const itGovDefense: Record<string, string> = {
	...
	"ind.meta.description":
		"Automazione di workflow air-gapped per dati classificati e infrastruttura sovrana. Flow-Like funziona interamente on-premise senza dipendenze cloud.",
	...
	"ind.problem.item3":
		"Ogni processo deve essere auditabile, riproducibile e spiegabile agli organi di supervisione e conformità.",
	...
	"ind.solution.item4.desc":
		"I nodi personalizzati vengono eseguiti in una sandbox WASM con permessi basati sulle capacità. Nessun accesso non autorizzato al file system o alla rete.",
	...
	"ind.cta.description":
		"Programmate un briefing con il nostro team. Vi mostreremo come Flow-Like soddisfa i vostri requisiti di sicurezza, conformità e air-gap.",
