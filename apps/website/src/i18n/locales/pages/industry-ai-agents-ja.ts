export const jaAiAgents: Record<string, string> = {
	...
	"ind.meta.description":
		"LLM 呼び出し、RAG Pipelines、マルチエージェントシステムを完全な説明可能性で統合管理。Flow-Like は AI ワークフローを視覚的、テスト可能、本番対応にします。",
	"ind.hero.tagline": "AI Agents",
	"ind.hero.headline": "オーケストレーション",
	"ind.hero.headline.highlight": "AI Agents",
	"ind.hero.description":
		"マルチエージェントシステム、RAG Pipelines、LLM オーケストレーションワークフローを視覚的に構築 — 完全な可観測性、型安全性、説明可能性を組み込み。",
	...
	"ind.cta.description":
		"Flow-Like がチームの信頼性が高く説明可能な AI システム構築をどう支援できるかご覧ください。お客様の具体的な AI ユースケースに合わせたデモをご予約ください。",
