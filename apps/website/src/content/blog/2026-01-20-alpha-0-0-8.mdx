...
- More Discord APIs
- More Telegram APIs
- Better Excel Extraction (AI and standard)
- Better Agent Handling (Infinite Context, etc)
- Github Copilot Nodes
- Improved Extraction Nodes (more formats, better accuracy, etc)
