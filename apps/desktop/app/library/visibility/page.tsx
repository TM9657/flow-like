...
import { AppCard, Button, EmptyState, IApp, IMetadata, Separator, useBackend, useInvoke } from "@tm9657/flow-like-ui"
import { EyeIcon, FilesIcon, LayoutGridIcon, LibraryIcon, Sparkles } from "lucide-react";
...
export default function Page() {
    ...
    return (<main className="min-h-dvh max-h-dvh flex flex-col w-full p-6 bg-gradient-to-br from-background to-muted/20">
        <div className="mb-4 flex items-center justify-between">
            ...
            <Button onClick={async () => {
                ...
                for await (const app of Array.from(appsToAdd)) {
                    await backend.userState.updateProfileApp(currentProfile.data, {
                        app_id: app,
                        favorite: false,
                        pinned: false
                    }, "Upsert")
