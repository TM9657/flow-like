...
use flow_like::{app::App, credentials::SharedCredentials, flow_like_storage::{arrow_schema::Schema, databases::vector::{lancedb::LanceDBVectorStore, VectorStore}, Path}, profile::ProfileApp};
use tauri::AppHandle;
...
async fn db_connection(app_handle: &AppHandle, app_id: String, table_name: Option<String>, credentials: Option<Arc<SharedCredentials>>) -> flow_like_types::Result<LanceDBVectorStore> {
