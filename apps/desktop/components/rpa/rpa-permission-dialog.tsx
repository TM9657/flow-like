...
export function RpaPermissionDialog({
  ...
  const [permissions, setPermissions] = useState<RpaPermissionStatus | null>(null);
  ...
  const requestPermission = async (type: "accessibility" | "screen_recording") => {
    try {
  ...
  return (
    <div
      className={cn(
        ...
        granted ? "border-green-500/30 bg-green-500/10" : "border-orange-500/30 bg-orange-500/10"
      )}
    >
