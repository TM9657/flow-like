...
import { MockHostBridge, setHost, getHost } from "../src/host";
...
describe("MockHostBridge", () => {
  ...
  describe("storage", () => {
    ...
    it("reads and writes storage", () => {
      const path: FlowPath = { path: "test/file.bin", store_ref: "s", cache_store_ref: null };
    ...
    it("lists storage entries", () => {
      const base: FlowPath = { path: "dir/", store_ref: "s", cache_store_ref: null };
      host.storageWrite({ path: "dir/a.txt", store_ref: "s", cache_store_ref: null }, new Uint8Array([1]));
      host.storageWrite({ path: "dir/b.txt", store_ref: "s", cache_store_ref: null }, new Uint8Array([2]));
      host.storageWrite({ path: "other/c.txt", store_ref: "s", cache_store_ref: null }, new Uint8Array([3]));
