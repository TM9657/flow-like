...
export interface HostBridge {
  ...
  httpRequest(method: number, url: string, headers: string, body: Uint8Array | null): string | null;
}
...
export class MockHostBridge implements HostBridge {
  ...
  httpRequest(_method: number, _url: string, _headers: string, _body: Uint8Array | null): string | null {
...
class DefaultHostBridge implements HostBridge {
  ...
  getVariable(_name: string): unknown { return null; }
  setVariable(_name: string, _value: unknown): boolean { return false; }
  deleteVariable(_name: string): void {}
  hasVariable(_name: string): boolean { return false; }
  cacheGet(_key: string): unknown { return null; }
  cacheSet(_key: string, _value: unknown): void {}
  cacheDelete(_key: string): void {}
  cacheHas(_key: string): boolean { return false; }
  timeNow(): number { return 0; }
  random(): number { return 0; }
  storageDir(_nodeScoped: boolean): FlowPath | null { return null; }
  uploadDir(): FlowPath | null { return null; }
  cacheDir(_nodeScoped: boolean, _userScoped: boolean): FlowPath | null { return null; }
  userDir(_nodeScoped: boolean): FlowPath | null { return null; }
  storageRead(_flowPath: FlowPath): Uint8Array | null { return null; }
  storageWrite(_flowPath: FlowPath, _data: Uint8Array): boolean { return false; }
  storageList(_flowPath: FlowPath): FlowPath[] | null { return null; }
  embedText(_bit: Record<string, unknown>, _texts: string[]): number[][] | null { return null; }
  getOAuthToken(_provider: string): Record<string, unknown> | null { return null; }
  hasOAuthToken(_provider: string): boolean { return false; }
  httpRequest(_method: number, _url: string, _headers: string, _body: Uint8Array | null): string | null { return null; }
}
